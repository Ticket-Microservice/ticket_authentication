...
defmodule TicketAuthentications.Greeter.Service do
  ...
  use GRPC.Service, name: "TicketAuthentications.Greeter", protoc_gen_elixir_version: "0.13.0"
    ...
    %Google.Protobuf.ServiceDescriptorProto{
      ...
      method: [
        %Google.Protobuf.MethodDescriptorProto{
          name: "SayHello",
          input_type: ".TicketAuthentications.HelloRequest",
          output_type: ".TicketAuthentications.HelloReply",
